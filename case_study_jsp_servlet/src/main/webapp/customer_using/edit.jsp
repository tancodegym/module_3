...
<html>
<head>
    <title>Edit Customer Using Service</title>
...
<center>
    <h1 class="text-primary">Edit Customer Using Service</h1>
</center>
<h2>
    ...
    <form method="post">
        <table border="1" cellpadding="5">
            ...
            <tr>
                <th>Salary:</th>
                <td>
                    <input type="text" name="salary" id="salary" size="45" value="${employee.employee_salary}" />
                </td>
            </tr>
            <tr>
                <th>Employee Birthday:</th>
                <td>
                    <input type="date" name="birthday" id="birthday" size="45" value="${employee.birthday}" />
                </td>
            </tr>
            <tr>
