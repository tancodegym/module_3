...
<html>
<head>
    <title>Contract Detail Page</title>
    ...
    <div class="row bg-secondary">
        <div class="col-12">
            <ul class="nav justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/contract?action=contract">Contract List</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/contract_detail?action=create_contract_detail">Add Contract Detail</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="row text-center bg-primary">
        <div class=col-12><h2>List of Contract Detail</h2></div>
    </div>
    <div class="row">
